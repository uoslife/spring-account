...
class RestDocsField(val descriptor: FieldDescriptor) {
...
infix fun String.type(docsFieldType: DocsFieldType): RestDocsField {
...
private fun createField(
    ...
    val descriptor = PayloadDocumentation.fieldWithPath(value).type(type).description("")
