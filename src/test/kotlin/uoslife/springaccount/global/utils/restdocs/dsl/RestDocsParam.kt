package uoslife.springaccount.global.utils.restdocs.dsl
...
class RestDocsParam(val descriptor: ParameterDescriptor)

infix fun String.pathMeans(description: String): RestDocsParam {
...
private fun createField(
    ...
    val descriptor = RequestDocumentation.parameterWithName(value).description(description)
